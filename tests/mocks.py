...
from core.agent import AgentTask, ToolAgent
...
task_list = TaskList(steps=[task_1, task_2])
...
class WeatherAgent(ToolAgent):
    ...
    backstory: str = (
        "I am a weather agent that has been helping people check the weather since 2024"
    )
    ...
    def execute(self, task: AgentTask) -> Dict[str, Any]:
        ...
        return {"temperature": 72, "conditions": "sunny", "location": "New York"}
...
agent_list = [WeatherAgent(), TodoAgent()]
